...
| --- | --- |
| Explain the advantage of linking commands with pipes and filters. | How can I combine existing commands to produce a desired output? |
| Combine sequences of commands to get new output | How can I show only part of the output? |

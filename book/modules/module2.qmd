...
| Translate an absolute path into a relative path and vice versa. | How can I see what files and directories I have? |
| Construct absolute and relative paths that identify specific files and directories. | How can I specify the location of a file or directory on my computer? |

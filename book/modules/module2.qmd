...
subtitle: Navigating directories and finding files
time: "0:30"
execute: 
  cache: true
  freeze: true
...
| --- | --- |
| Explain the similarities and differences between a file and a directory. | How can I move around on my computer? |
| Understand absolute paths and relative paths. | How can I see what files and directories I have? |
| Use options and arguments to change the behaviour of a shell command. | How can I specify the location of a file or directory on my computer? |
| Demonstrate the use of tab completion and explain its advantages. |


The part of the operating system responsible for managing files and directories
is called the **file system**.
It organizes the data on our disk into files,
which hold information,
and directories (also called 'folders'),
which hold files or other directories.

These files and directories can be created, inspected, renamed, and deleted with commands that we need to learn first.
...
![](https://swcarpentry.github.io/shell-novice/fig/filesystem.svg){alt='The file system is made up of a root directory that contains sub-directories titled bin, data, users, and tmp'}
...
![](https://swcarpentry.github.io/shell-novice/fig/home-directories.svg){alt='Like other directories, home directories are sub-directories underneath "/Users" like "/Users/imhotep", "/Users/larry" or"/Users/nelle"'}
...
Can you also combine the options into one `-lh`?
...
Your output shows a list of all the files and sub-directories in your
...
The command doesn't actually modify (or 'change') the directory;
...
called `.bash_profile` and `.bashrc`. These files contain shell configuration
settings. You may also see other files and directories beginning
with `.`. These are usually configuration files that were created by
different programs on your computer. The prefix `.` is used to prevent these
configuration files from cluttering the output of the regular `ls` command
is used.
...
which is `/Users/nelle`? And what do the other commands do?
...
what will `ls -F ../backup` display? And why?
...
All commands have the same structure, of the command itself, options, and arguments.
...
![](https://swcarpentry.github.io/shell-novice/fig/shell_command_syntax.svg){alt='General syntax of a shell command'}
...
### Tab completion, or how Nelle can type less
